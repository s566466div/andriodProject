...
public class ab_negativefrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_ab_negativefrag, container, false);

        // Initialize RecyclerView
        recyclerView = view.findViewById(R.id.abnegativeView);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("donors").child("ab-Donors");
