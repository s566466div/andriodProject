...
public class o_positivefrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.o_positivelfrag, container, false);

        // Initialize RecyclerView
        recyclerView = view.findViewById(R.id.opositiveView);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("donors").child("o-Donors");
