...
public class ab_positivefrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_ab_positivefrag, container, false);

        // Initialize RecyclerView
        recyclerView = view.findViewById(R.id.abpositiveView);
