...
public class heartList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.heartlist);

        // Initialize RecyclerView
        recyclerView = findViewById(R.id.heartView);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("donors").child("heartDonors");
    ...
    private void fetchDonorDetails() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                // Handle errors
                Toast.makeText(heartList.this, "Failed to fetch donor details: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
