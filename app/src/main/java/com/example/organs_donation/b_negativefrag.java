...
public class b_negativefrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.b_negativefrag, container, false);

        // Initialize RecyclerView
        recyclerView = view.findViewById(R.id.bnegativeView);
